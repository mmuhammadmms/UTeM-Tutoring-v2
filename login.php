					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-2" id="link-effect-2">
							<ul class="nav navbar-nav">
								<li><a href="about.html" class="effect-3">Subject</a></li>
								<li><a href="about.html" class="effect-3">CLASS</a></li>
...
<!-- stats -->
	...
	<div class="limiter">
		...
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('images/utem1.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="loginp.php" method="post">
					...
					<div style="margin-bottom:50px;" class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
